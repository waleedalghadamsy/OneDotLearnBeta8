...
{
    internal class SwDevCoursesPopulator
    {
        internal static void AddCourses()
        {
            int LibyaId = 1, EgyptId = 2, TurkeyId = 11, AmericaId = 19;
            //var datHelper = OdlDataHelper.Instance;
            var picsPath = @"C:\Users\pc\Source\Repos\OneDotLearnBeta4\Presentation\Web\"
                            + @"OneDotLearnWebApp\wwwroot\img";
            //var crsId = CourseId;
            ...
            {
                (LibyaId, 200), (EgyptId, 750), (TurkeyId, 750),
                        (AmericaId, 40)
            });
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 250), (EgyptId, 800), (TurkeyId, 800),
                (AmericaId, 45)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 300), (EgyptId, 850), (TurkeyId, 850),
                (AmericaId, 53)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion

            #region 04 Adv. Java Programming - 18H - L 350 | E 950 | T 950 | A (70 + 63 + 45) / 3 ~ 60
            crsId = 4;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 350), (EgyptId, 950), (TurkeyId, 950),
                (AmericaId, 60)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion

            #region 05 C# Programming - 24H - L 300 | E 850 | T 850 | A (60 + 57 + 41) / 3 ~ 53
            crsId = 5;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            #region 06 Adv. C# Programming - 18H - L 350 | E 950 | T 950 | A (70 + 63 + 45) / 3 ~ 60
            crsId = 6;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            #region 07 Web Apps C# - 30H - L 500 | E 1300 | T 1300 | A (100 + 87 + 52) / 3 = 80
            crsId = 7;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 500), (EgyptId, 1300), (TurkeyId, 1300),
                (AmericaId, 80)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion

            #region 08 Adv. Web Apps C# - 18H - L 400 | E 1000 | T 1000 | A (80 + 64 + 48) / 3 = 65
            crsId = 8;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 400), (EgyptId, 1000), (TurkeyId, 1000),
                (AmericaId, 65)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion

            #region 09 Web Apps PHP - 30H - L 500 | E 1300 | T 1300 | A (100 + 87 + 52) / 3 = 80
            crsId = 9;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            #region 10 Android Apps Using Java - 30H - L 600 | E 1500 | T 1500 | A (120 + 100 + 59) / 3 ~ 95
            crsId = 10;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 600), (EgyptId, 1500), (TurkeyId, 1500),
                (AmericaId, 95)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion

            #region 11 Adv. Andr. Apps Us. Java - 18H - L 450 | E 1200 | T 1200 | A (90 + 76 + 50) / 3 ~ 75
            crsId = 11;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 450), (EgyptId, 1200), (TurkeyId, 1200),
                (AmericaId, 75)
            });
            CoursesDetailsPopulator.CoursesInstructors.Add(crsId, new List<int>() { 1 });
            #endregion

            #region 12 Android Apps Us. Xam. - 30H - L 600 | E 1500 | T 1500 | A (120 + 100 + 59) / 3 ~ 95
            crsId = 12;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            #region 13 Adv. Andr. Apps Us. Xam. - 18H - L 450 | E 1200 | T 1200 | A (90 + 76 + 50) / 3 ~ 75
            crsId = 13;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            #region 14 Intr. Games Prg. Unity & C# - 18H - L 600 | E 1500 | T 1500 | A (120 + 100 + 59) / 3 ~ 95
            crsId = 14;
            CoursesPopulator.AddCourse(new Course()
            {
                Id = crsId,
            ...
            CoursesDetailsPopulator.CoursesFees.Add(crsId, new List<(int ctryId, float fees)>()
            {
                (LibyaId, 450), (EgyptId, 1200), (TurkeyId, 1500),
                (AmericaId, 95)
            });
            #endregion
        }
